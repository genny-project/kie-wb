<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("out_mobile");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid out_mobile");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: user-registration.EnterMobile
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">in_status</label>
                            		<div class="div_checkbox">
                              		${in_status}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">out_mobile</label>
                            		<div class="div_texbox">
                              		<input name="out_mobile" type="text" class="textbox" id="out_mobile" value="${out_mobile}" />
                            		</div>
