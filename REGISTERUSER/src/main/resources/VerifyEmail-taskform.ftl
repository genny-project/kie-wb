<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("verifyEmail");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid verifyEmail");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: WF_REGISTERUSER.VerifyEmail
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">verifyEmail</label>
                            		<div class="div_checkbox">
                              		<input name="verifyEmail" type="checkbox" class="checkbox" id="verifyEmail" value="${verifyEmail}" />
                            		</div>
