<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("out_code");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid out_code");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: WF_REGISTERUSER.EnterVerificationCode
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">in_mobile</label>
                            		<div class="div_checkbox">
                              		${in_mobile}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">out_code</label>
                            		<div class="div_texbox">
                              		<input name="out_code" type="text" class="textbox" id="out_code" value="${out_code}" />
                            		</div>
