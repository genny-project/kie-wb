<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					...
					i++;
					myInputs[i] = document.getElementById("userType");
					i++;
...
<div id="container">
	<div id="header">
		New Process Instance: /REGISTERUSER/src/main/resources.WF_REGISTERUSER
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Process inputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="userType" type="text" class="textbox" id="userType" value="" />
                            		</div>
